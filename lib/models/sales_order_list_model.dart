...
List<SalesOrderListModel> salesOrderListModelFromJson(String str) => List<SalesOrderListModel>.from(json.decode(str).map((x) => SalesOrderListModel.fromJson(x)));

String salesOrderListModelToJson(List<SalesOrderListModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
