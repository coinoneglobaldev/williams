...
//
//     final transportItemListModel = transportItemListModelFromJson(jsonString);

import 'dart:convert';

List<TransportItemListModel> transportItemListModelFromJson(String str) =>
    List<TransportItemListModel>.from(
        json.decode(str).map((x) => TransportItemListModel.fromJson(x)));

String transportItemListModelToJson(List<TransportItemListModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class TransportItemListModel {
  String autoId;
  String id;
  String tokenNo;
  String invoiceId;
  ...
  TransportItemListModel({
    ...
    required this.curRateVal,
    required this.curRateFrm,
    required this.curRateTotal,
    required this.isChk,
    required this.chkDateTime,
  });

  factory TransportItemListModel.fromJson(Map<String, dynamic> json) =>
      TransportItemListModel(
        autoId: json["AutoId"],
        id: json["ID"],
        ...
        curRateVal: json["CurRateVal"],
        curRateFrm: json["CurRateFrm"],
        curRateTotal: json["CurRateTotal"],
        isChk: json["IsChk"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "CurRateVal": curRateVal,
        "CurRateFrm": curRateFrm,
        "CurRateTotal": curRateTotal,
        "IsChk": isChk,
